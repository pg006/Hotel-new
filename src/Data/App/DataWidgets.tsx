...
export class TotalRevenue extends React.Component<{}, { series: any, options: any }> {
  constructor(props) {
    super(props);
...
export class SupportCost extends React.Component<{}, { series: any, options: any }> {
  constructor(props) {
    super(props);
...
export class TotalRequest extends React.Component<{}, { series: any, options: any }> {
  constructor(props) {
    super(props);
...
export class RequestsAnswered extends React.Component<{}, { series: any, options: any }> {
  constructor(props) {
    super(props);
...
export class Gallery extends React.Component<{}, { photoIndex: any, isOpen: any }> {
  constructor(props) {
    super(props);
