...
export const LtrtoRtl = () => {
  ...
  export function checkHoriMenu() {
    let menuWidth: Element | HTMLElement | any = document.querySelector(".horizontal-main");
    let menuItems:  Element | HTMLElement | any = document.querySelector(".side-menu");
    let mainSidemenuWidth: Element | HTMLElement | any = document.querySelector(".main-sidemenu");
  ...
  export function handleThemeUpdate(cssVars) {
    const root: Element | HTMLElement | any = document.querySelector(":root");
  ...
  export function localStorageBackUp() {
    ...
    if (
      ...
      body?.classList.remove("light-mode");
      body?.classList.remove("dark-mode");
      let img:string | any= localStorage.getItem("BgImage");
      html?.setProperty(
        "--primary-bg-color",
        localStorage.getItem("transparent-bgImgPrimaryColor")
      );
  ...
  export function switcherArrowFn() {
    let slideLeft : Element | HTMLElement | any = document.querySelector(".slide-left");
    let slideRight : Element | HTMLElement | any = document.querySelector(".slide-right");
    ...
    function slideClick() {
      ...
      slide.forEach((element: Element | HTMLElement | any) => {
        if (element.classList.contains("is-expanded") === true) {
          element.classList.remove("is-expanded");
        }
      });
      sideMenuitem.forEach((element: Element | HTMLElement | any) => {
        if (element.classList.contains("active") === true) {
          element.classList.remove("active");
        }
      });
      slideMenu.forEach((element: Element | HTMLElement | any) => {
        if (element) {
    ...
    let slideLeftLTR: Element | HTMLElement | any = document.querySelector(".slide-left");
    let slideRightLTR: Element | HTMLElement | any = document.querySelector(".slide-right");
    ...
    slideLeftLTR.addEventListener("click", () => {
      ...
      subNavSub.forEach((e: Element | HTMLElement | any) => {
        e.style.display = "";
      });
      let subNav = document.querySelectorAll(".nav-sub");
      subNav.forEach((e: Element | HTMLElement | any) => {
        e.style.display = "";
      });
    });
    ...
    let slideLeftRTL: Element | HTMLElement | any = document.querySelector(".slide-leftRTL");
    let slideRightRTL: Element | HTMLElement | any = document.querySelector(".slide-rightRTL");
