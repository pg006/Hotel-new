  ...
  render() {
    ...
    return (
      <div className="indicator">
        <Slider {...settings}>
          <div className="">
            <img src={require("../../assets/images/landing/web/react.png")} alt='web-1' />
            <h5 className="mt-3 text-white">REACT</h5>
          </div>
          <div className="">
            <img src={require("../../assets/images/landing/web/TYPESCRIPT.png")} alt='web-2' />
            <h5 className="mt-3 text-white">TYPESCRIPT</h5>
          </div>
          <div className="">
            <img src={require("../../assets/images/landing/web/RB.png")} alt='web-3' />
            <h5 className="mt-3 text-white">REACT-BOOTSTRAP</h5>
          </div>
          <div className="">
            <img src={require("../../assets/images/landing/web/NPM.png")} alt='web-4' />
            <h5 className="mt-3 text-white">NPM</h5>
          </div>
          <div className="">
            <img src={require("../../assets/images/landing/web/YARN.png")} alt='web-5' />
            <h5 className="mt-3 text-white">YARN</h5>
          </div>
          <div className="">
            <img src={require("../../assets/images/landing/web/SASS.png")} alt='web-6' />
            <h5 className="mt-3 text-white">SASS</h5>
          </div>
          <div className="">
            <img src={require("../../assets/images/landing/web/CSS.png")} alt='web-7' />
            <h5 className="mt-3 text-white">CSS</h5>
          </div>
          <div className="">
            <img src={require("../../assets/images/landing/web/MUI.png")} alt='web-8' />
            <h5 className="mt-3 text-white">MUI</h5>
          </div>
          <div className="">
            <img src={require("../../assets/images/landing/web/GULP.png")} alt='web-9' />
