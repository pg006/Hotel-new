            ...
            <div className="product-grid6">
              <div className="product-image6 p-5">
                ...
                <Link to={`/Ecommerce/shoppingcart`} className="bg-light">
                  <img className="img-fluid br-7 w-100" src={item.img} alt="img" />
                </Link>
              </div>
              <Card.Body className="pt-0">
                <div className="product-content text-center">
                  <h1 className="title fw-bold fs-20"><Link to={`/Ecommerce/shoppingcart`}>{item.heading}</Link></h1>
              ...
              <Card.Footer className="text-center">
                <Link to={`/Ecommerce/shoppingcart`} className="btn btn-primary ms-2 mb-1"><i className="fe fe-shopping-cart me-2"></i>Add to cart</Link>
