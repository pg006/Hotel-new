            ...
            <Row>
              ...
              <Col xl={6} xxl={4} md={6}>
                <Form.Group>
                  ...
                  <label className="custom-switch form-switch me-5 mb-3">
                    <input type="checkbox" name="custom-switch-checkbox1" className="custom-switch-input" />
                ...
                <Form.Group>
                  <label className="custom-switch form-switch mb-3">
                    <input type="checkbox" name="custom-switch-checkbox2" className="custom-switch-input" defaultChecked />
                    <span className="custom-switch-indicator custom-switch-indicator-lg"></span>
                    <span className="custom-switch-description">Active</span>
                  </label>
                </Form.Group>
