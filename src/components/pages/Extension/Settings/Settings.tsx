        ...
        <Card>
          <Card.Body>
            <ListGroup className="list-group-transparent mb-0 file-manager file-manager-border">
              <h4>General</h4>
              <div>
                <Link to='#'><ListGroup.Item eventKey='#link' href="#" className="d-flex align-items-center px-0 border-top">
                  <i className="fe fe-user fs-18 me-2 text-success p-2"></i>Account
                </ListGroup.Item></Link>
              </div>
              <div>
                <Link to='#'><ListGroup.Item href="#link1" className="d-flex align-items-center px-0">
                  <i className="fe fe-bell fs-18 me-2 text-secondary p-2"></i>Notifications
                </ListGroup.Item></Link>
              </div>
              <div>
                <Link to='#'><ListGroup.Item href="#link2" className="d-flex align-items-center px-0">
                  <i className="fe fe-eye fs-18 me-2 text-primary p-2"></i> Appearances
                </ListGroup.Item></Link>
              </div>
              <div>
                <Link to='#'><ListGroup.Item href="#link3" className="d-flex align-items-center px-0">
                  <i className="fe fe-lock fs-18 me-2 text-warning p-2"></i> Privacy & Security
                </ListGroup.Item></Link>
              </div>
              <div>
                <Link to='#'><ListGroup.Item href="#link4" className="d-flex align-items-center px-0">
                  <i className="fe fe-headphones fs-18 me-2 text-info p-2"></i> Help & Support
                </ListGroup.Item></Link>
              </div>
              <div>
                <Link to='#'><ListGroup.Item href="#link5" className="d-flex align-items-center px-0">
                  <i className="fe fe-database fs-18 me-2 text-pink p-2"></i> Data Usage Control
                </ListGroup.Item></Link>
              </div>
              <div>
                <Link to='#'><ListGroup.Item href="#link6" className="d-flex align-items-center px-0">
                  <i className="fe fe-battery-charging fs-18 me-2 text-green p-2"></i> Power Saving Management
                </ListGroup.Item></Link>
              </div>
              <div>
                <Link to='#'><ListGroup.Item href="#link7" className="d-flex align-items-center px-0">
