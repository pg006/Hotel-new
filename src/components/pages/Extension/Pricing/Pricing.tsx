...
const Pricing: FC<PricingProps> = () => (
  <div className={styles.Pricing}>
      ...
      <Col sm={6} xl={3} md={6} lg={6}>
        <div className="panel price panel-color">
          ...
          <div className="panel-body p-0 ps-5">
            ...
            <p><i className="fe fe-plus me-1"></i>$1.9 per Listing</p>
          </div>
      ...
      <Col sm={6} xl={3} md={6} lg={6}>
        <div className="panel price panel-color bg-success-transparent">
          ...
          <div className="panel-body p-0 ps-5">
            ...
            <p className="mb-0 pb-4"><i className="fe fe-plus me-1"></i>$1.9 per Listing</p>
          </div>
          <div className="panel-footer text-center px-5 border-0 pt-0">
    ...
    <Row>
      ...
      {/* <!-- COL-END --> */}
      <Col sm={6} xl={3} md={6} lg={6} className="danger">
        <Card>
          <div className="princing-item">
            <div className="pricing-divider text-center pt-5">
      ...
      <Col sm={6} xl={3} md={6} lg={6} className="success">
        <Card>
          <div className="princing-item">
            <div className="pricing-divider text-center pt-5">
      ...
      {/* <!-- COL-END --> */}
      <Col sm={6} xl={3} md={6} lg={6} className="secondary">
