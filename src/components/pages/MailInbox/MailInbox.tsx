...
const MailInbox: FC<MailInboxProps> = () => (
      ...
      <Col xl={3}>
        <Card>
          <ListGroup className="list-group-transparent mb-0 mail-inbox pb-3" defaultActiveKey='#link'>
            ...
            <Link to='#'><ListGroup.Item href="#link2" className="d-flex align-items-center mx-4">
              <span className="icons"><i className="ri-star-line"></i></span> Starred <Badge bg='success' className="ms-auto bradius">03</Badge>
            </ListGroup.Item></Link>
            <Link to='#'><ListGroup.Item href="#link3" className="d-flex align-items-center mx-4">
              <span className="icons"><i className="ri-price-tag-3-line"></i></span> Tags
            </ListGroup.Item></Link>
            <Link to='#'><ListGroup.Item href="#link4" className="d-flex align-items-center mx-4">
              <span className="icons"><i className="ri-mail-send-line"></i></span> Sent Mail
            </ListGroup.Item></Link>
            <Link to='#'><ListGroup.Item href="#5" className="d-flex align-items-center mx-4">
          ...
          <Card.Body className="border-top p-0 py-3">
            <ListGroup className="list-group-transparent mb-0 mail-inbox mx-4">
              <ListGroup.Item href="#" className="list-group-item-action d-flex align-items-center py-2">
                        ...
                        {tableData.map((item) => (
                          <tr className={item.className} key={item.id}>
                            <td className="inbox-small-cells">
                              <Form.Check type="checkbox" id="custom-check" className="mb-0 ms-6" />
                            </td>
