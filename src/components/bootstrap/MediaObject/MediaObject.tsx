          ...
          <Card.Body>
            <div className="example">
              <div className="media media-lg mt-0">
                <img className="avatar avatar-xl bradius me-3 mb-4 w-100p h-10" src={require("../../../assets/images/media/media3.jpg")} alt="Generic placeholder"/>
      ...
      <Col>
        <Card className="Relatedpost nested-media overflow-hidden">
          ...
          <Card.Body className="overflow-hidden">
            <div className="example">
              <div className="media media-lg mt-0">
                <img className="avatar avatar-xl bradius me-3 mb-4 w-100p h-10" src={require("../../../assets/images/media/media5.jpg")} alt="Generic placeholder"/>
                  <div className="media-body overflow-hidden">
                    <h4 className="mt-0">Media heading</h4>
                    <p className="text-muted mb-0 fs-14">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.</p>
                    <div className="media media-lg mt-3">
                      <img className="avatar avatar-xl bradius me-3 mb-4 w-100p h-10" src={require("../../../assets/images/media/media2.jpg")} alt="Generic placeholder"/>
                        <div className="media-body overflow-hidden">
                          <h4 className="mt-0">Media heading</h4>
                          <p className="text-muted mb-0 fs-14">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.</p>
                        </div>
            ...
            <div className="example">
              <ul className="list-unstyled">
                <li className="media media-lg mt-0 border-bottom-0">
                  <img className="avatar avatar-xl bradius me-3 mb-4 w-100p h-10" src={require("../../../assets/images/media/media4.jpg")} alt="Generic placeholder"/>
                    <div className="media-body">
      ...
      <Col>
        <Card className="Relatedpost nested-media">
          ...
          <Card.Body>
            <div className="example">
              <div className="media media-lg mt-0">
                <img className="align-self-start avatar avatar-xl bradius me-3 mb-4 w-100p h-10" src={require("../../../assets/images/media/media3.jpg")} alt="Generic placeholder"/>
                  <div className="media-body">
              ...
              <div className="media media-lg">
                <img className="align-self-center avatar avatar-xl bradius me-3 mb-4 w-100p h-10" src={require("../../../assets/images/media/media5.jpg")} alt="Generic placeholder"/>
                  <div className="media-body">
              ...
              <div className="media media-lg">
                <img className="align-self-end avatar avatar-xl bradius me-3 mb-4 w-100p h-10" src={require("../../../assets/images/media/media4.jpg")} alt="Generic placeholder"/>
                  <div className="media-body">
          ...
          <Card.Body>
            <div className="example">
              <div className="media media-lg mt-0">
                ...
                <img className="ms-2 mt-3 mb-3 bradius w-100p h-10" src={require("../../../assets/images/media/media2.jpg")} alt="Generic placeholder"/>
              </div>
            </div>
          </Card.Body>
        </Card>
