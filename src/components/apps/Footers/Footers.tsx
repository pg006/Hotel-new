          ...
          <Card.Body>
            <div className="top-footer">
              <Row>
                ...
                <Col lg={4} sm={12} md={4}>
                  <h6>Posts</h6>
                  <img alt="" src={require("../../../assets/images/media/media1.jpg")} />
                  <img alt="" src={require("../../../assets/images/media/media2.jpg")} />
                  <img alt="" src={require("../../../assets/images/media/media3.jpg")} />
                  <img alt="" src={require("../../../assets/images/media/media4.jpg")} />
                  <hr />
