// import styles from './FullCalender.module.scss';
...
class FullCalenderComponent extends React.Component<any> {
        ...
        <Row>
          <Col md={12}>
            <Card>
              ...
              <Card.Body>
                <Row>
                  <Col md={5} xl={3} className="animated fadeIn p-4 demo-app">

                    <div id="external-events" style={{ padding: "10px", width: "80%", height: "auto", maxHeight: "-webkit-fill-available" }}>
                  ...
                  <Col md={7} xl={9} className="demo-app-calendar" id="mycalendartest">
