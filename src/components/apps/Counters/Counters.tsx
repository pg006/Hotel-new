...
import { DayCounter, CountDaysLimit, TimeCounting, TimeMinutesCounter, DataCount } from '../../../Data/App/DataCounter';
          ...
          <Card.Body>
            <div className="example card-transparent bg-warning-transparent border-warning text-warning">
              <div className="d-flex d-xs-grid">
                <span className="fs-30 pe-5"><i className="bi bi-alarm"></i></span>
                <div className="">
                  {/* <span id="timer-countercallback" className="h3"></span> */}
                  <TimeMinutesCounter />
                  <h5 className="mb-0 mt-1">Only 6 min left</h5>
                </div>
          ...
          <Card.Body className="mx-auto">
            <div className="example border border-secondary pb-4 px-5">
              ...
              <div>
                ...
                <span className='h2 text-secondary'>{<CountDaysLimit />} </span>
      ...
      <Col md={12} lg={4} xl={4}>
        <Card>
          ...
          <Card.Body className="text-center">
            ...
            <h5>Profit</h5>
            {/* <h2  className='counter'> 2,56989.32</h2> */}
