                ...
                <Card.Body>
                  ...
                  <div className="d-flex">
                    <Card.Body className="px-0">
                      ...
                      {/* <Form.Range className='text-primary'/> */}
                    </Card.Body>
                  </div>
                </Card.Body>
              </Card>
                ...
                <Card.Body>
                  <div className="">
                    <div className="d-flex overflow-visible">
                      <img className="avatar bradius avatar-xl me-4 p-2 bg-white border" src={require("../../../assets/images/pngs/8.png")} alt="avatar-img" />
                    ...
                    <div className="d-flex overflow-visible mt-5">
                      <img className="avatar bradius avatar-xl me-4 p-2 bg-white border" src={require("../../../assets/images/pngs/1.png")} alt="avatar-img" />
                      <div className="media-body valign-middle">
                    ...
                    <div className="d-flex overflow-visible mt-5">
                      <img className="avatar bradius avatar-xl me-4 p-2 bg-white border" src={require("../../../assets/images/pngs/6.png")} alt="avatar-img" />
                      <div className="media-body valign-middle">
                    ...
                    <Row>
                      <Col xl={5} lg={8} md={8} sm={8}>
                        <InputGroup className="d-flex w-100 float-start">
                          <FormControl type="text" className="border-end-0 my-2" placeholder="Search ..." />
                              ...
                              <div className="product-grid6">
                                ...
                                <Card.Body className="pt-0">
                                  <div className="product-content text-center">
                                    ...
                                    <div className="price">$599<span className="ms-4">$799</span>
                                    </div>
                                  </div>
                                </Card.Body>
                              ...
                              <div className="product-grid6">
                                ...
                                <Card.Body className="pt-0">
                                  <div className="product-content text-center">
                                    ...
                                    <div className="price">$1,399<span className="ms-4">$1,599</span>
                                    </div>
                                  </div>
                                </Card.Body>
                                <Card.Footer className="text-center">
                              ...
                              <div className="product-grid6">
                                ...
                                <Card.Body className="pt-0">
                                  <div className="product-content text-center">
                                    ...
                                    <div className="price">$1,299<span className="ms-4">$1,899</span>
                                    </div>
                                  </div>
                                </Card.Body>
                                <Card.Footer className="text-center">
                              ...
                              <div className="product-grid6">
                                ...
                                <Card.Body className="pt-0">
                                  <div className="product-content text-center">
                                    ...
                                    <div className="price">$16,599<span className="ms-4">$19,799</span>
                                    </div>
                                  </div>
                                </Card.Body>
                                <Card.Footer className="text-center">
                              ...
                              <div className="product-grid6">
                                ...
                                <Card.Body className="pt-0">
                                  <div className="product-content text-center">
                                    ...
                                    <div className="price">$2,299<span className="ms-4">$1,599</span>
                                    </div>
                                  </div>
                                </Card.Body>
                                <Card.Footer className="text-center">
                              ...
                              <div className="product-grid6">
                                ...
                                <div className="card-body pt-0">
                                  <div className="product-content text-center">
                                    ...
                                    <div className="price">$56,599<span className="ms-4">$59,799</span>
                                    </div>
                                  </div>
                                </div>
                                <Card.Footer className="text-center">
                              ...
                              <div className="product-grid6">
                                ...
                                <Card.Body className="pt-0">
                                  <div className="product-content text-center">
                                    ...
                                    <div className="price">$3,599<span className="ms-4">$3,799</span>
                                    </div>
                                  </div>
                                </Card.Body>
                                <Card.Footer className="text-center">
                              ...
                              <div className="product-grid6">
                                ...
                                <Card.Body className="pt-0">
                                  <div className="product-content text-center">
                                    ...
                                    <div className="price">$399<span className="ms-4">499</span>
                                    </div>
                                  </div>
                                </Card.Body>
                                <Card.Footer className="text-center">
                              ...
                              <div className="product-grid6">
                                ...
                                <Card.Body className="pt-0">
                                  <div className="product-content text-center">
                                    ...
                                    <div className="price">$6,599<span className="ms-4">$9,799</span>
                                    </div>
                                  </div>
                                </Card.Body   >
                                <Card.Footer className="text-center">
