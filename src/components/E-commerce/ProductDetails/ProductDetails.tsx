            ...
            <Row className="row-sm">
              ...
              <Col xl={7} lg={12} md={12} className="details mt-4 mt-xl-0">
                <div className="mt-2 mb-4">
                  <h3 className="mb-3 fw-semibold">Trending Half Hands Tshirt (Best Fabric Premium made T-shirt for Casual wear.)</h3>
                  ...
                  <h3 className="mb-4"><span className="me-2 fw-bold fs-25">$299 USD/</span><span><del className="fs-18 text-muted">$599</del></span></h3>
                  ...
                  <div className=" mt-4 mb-5"><span className="fw-bold me-2">Availability :</span><span className="fw-bold text-success">In-stock</span></div>
          ...
          <div className="product-grid6">
            ...
            <Card.Body className="pt-0">
              <div className="product-content text-center">
                ...
                <div className="price">$16,599<span className="ms-4">$18,299</span>
                </div>
              </div>
            </Card.Body>
          ...
          <div className="product-grid6">
            ...
            <Card.Body className="pt-0">
              <div className="product-content text-center">
                ...
                <div className="price">$16,599<span className="ms-4">$56,599</span>
                </div>
              </div>
            </Card.Body>
            <Card.Footer className="text-center">
          ...
          <div className="product-grid6">
            ...
            <Card.Body className="pt-0">
              <div className="product-content text-center">
                ...
                <div className="price">$16,599<span className="ms-4">$25,599</span>
                </div>
              </div>
            </Card.Body>
            <Card.Footer className="text-center">
          ...
          <div className="product-grid6">
            ...
            <Card.Body className="pt-0">
              <div className="product-content text-center">
                ...
                <div className="price">$16,599<span className="ms-4">$18,399</span>
                </div>
              </div>
            </Card.Body>
            <Card.Footer className="text-center">
