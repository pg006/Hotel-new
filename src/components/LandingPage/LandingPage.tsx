                    ...
                    <div className="demo-screen-headline main-demo main-demo-1 spacing-top overflow-hidden" id="home" onClick={() => SidSwitcherIcons()}>
                        <Container className="px-sm-0">
                            <Row>
                                ...
                                <Col xl={6} lg={6} className="my-auto"><img src={require("../../assets/images/landing/market4.png")} alt="" /></Col>
                            </Row>
                        </Container>
                    </div>
                </div>
                                                            ...
                                                            <Row>
                                                                <Col xl={6} lg={6} className="ps-0">
                                                                    <div className="text-center mb-3" >
                                                                        <img src={require("../../assets/images/landing/business-team-working-on-business-plan.png")} alt="" className="br-5" />
                                                                    </div>
                                                                </Col>
                                            ...
                                            <section className="sptb demo-screen-demo" id="faqs">
                                                <Row className="align-items-center">
                                                    ...
                                                    <Col md={12} lg={6} className="">
                                                        <img src={require("../../assets/images/landing/frequently-asked-questions.png")} alt="" />
                                                    </Col>
                                                </Row>
                                            </section>
                                        </Row>
                                        ...
                                        <Row>
                                            ...
                                            <Col lg={6}>
                                                <Card className="bg-transparent">
                                                    <Card.Body className="px-1">
                                                        <div className="d-flex overflow-visible">
                                                            <img className="card-aside-column br-5 cover-image" alt='about' src={require("../../assets/images/media/about.jpg")} />
