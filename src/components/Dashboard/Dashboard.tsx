            ...
            <Col lg={6} md={6} sm={12} xl={3}>
              <Card className="overflow-hidden">
                <Card.Body>
                  ...
                  <span className="text-muted fs-12"><span className="text-secondary me-2"><i
            ...
            <Col lg={6} md={6} sm={12} xl={3}>
              <div className="card overflow-hidden">
                <Card.Body>
                  ...
                  <span className="text-muted fs-12"><span className="text-pink me-2"><i
            ...
            <Col lg={6} md={6} sm={12} xl={3}>
              <div className="card overflow-hidden">
                <Card.Body>
                  ...
                  <span className="text-muted fs-12"><span className="text-green me-2"><i
            ...
            <Col lg={6} md={6} sm={12} xl={3}>
              <Card className="overflow-hidden">
                <Card.Body>
                  ...
                  <span className="text-muted fs-12"><span className="text-warning me-2"><i
            ...
            <Card.Body>
              <div className="d-flex mb-4 mt-3">
                ...
                <div className="">
                  ...
                  <p className="fw-normal fs-12"> <span className="text-success me-1">3.5%</span>
                    increased </p>
                </div>
              ...
              <div className="d-flex">
                ...
                <div className="">
                  ...
                  <p className="fw-normal fs-12"> <span className="text-success me-1">1.2%</span>
                    increased </p>
                </div>
                <div className=" ms-auto my-auto">
