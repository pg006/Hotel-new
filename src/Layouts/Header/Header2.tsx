                          ...
                          <Row as='ul' className="p-3">
                            <Col lg={6} as='li' className="mb-2">
                              <Link to="#" className="btn btn-country btn-lg btn-block active">
                                <span className="country-selector"><img alt="" src={require("../../assets/images/flags/us_flag.jpg")}
                            ...
                            <Col lg={6} as='li' className="mb-2">
                              <Link to="#" className="btn btn-country btn-lg btn-block">
                                <span className="country-selector"><img alt="" src={require("../../assets/images/flags/malaysia.jpg")}
                                  className="me-3 language" /></span>Malaysia
                              </Link>
                            </Col>
                            <Col lg={6} as='li' className="mb-2">
                              <Link to="#" className="btn btn-country btn-lg btn-block">
                                <span className="country-selector"><img alt="" src={require("../../assets/images/flags/turkey.jpg")}
