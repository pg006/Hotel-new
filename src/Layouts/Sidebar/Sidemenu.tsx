export const MENUITEMS = [
    ...
    },
    {
        ...
        Items: [
            ...
            { path: `/landingPage/landingPage`, badge: "badge bg-green br-5 side-badge blink-text pb-1",badgetxt:"New", icon: 'fe fe-zap', type: 'link', active: true, selected: false, title: 'Rates' },
        ]
    },
    {
